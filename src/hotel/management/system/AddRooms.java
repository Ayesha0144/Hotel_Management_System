...
public class AddRooms extends JFrame implements ActionListener{
    ...
    ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/bedroom3.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
            ...
            Conn c = new Conn();
            try{
                String str ="insert into rooms values('"+room+"','"+available+"','"+status+"','"+price+"','"+bed_type+"')";
